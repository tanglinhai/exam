            ...
            <el-main>
                ...
                <el-table
                    ...
                    <el-table-column
                        ...
                        <template slot-scope="scope">
                            <div>
                                <el-button size="small" @click="changeView('/operation/zjps/hldj/electWait')"><img style="display:inline-block; margin-top:-2px;" src="../../../common/img/icon16_comment.gif"/>推举</el-button>
                            </div>
                        </template>
                    </el-table-column>
                </el-table>
