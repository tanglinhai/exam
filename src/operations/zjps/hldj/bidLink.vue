  ...
  components: {
    ...
    mounted(){
        ...
        if(this.iframName=="1"){
            ...
            this.hldjType=false;
            if(!this.$loaclStore.get('31sxfHldjFirstwpb')){  //双信封都未评标
                this.firstXinfengPingbiao=true;   //第一信封评标按钮展示
                this.pingBiaoBtn=false;
            }else if(this.$loaclStore.get('31sxfHldjFirstwpb')=="311"){//第一个信封都已经评标
