    ...
    <div class="quexa_b">
      <el-tabs type="border-card" v-model="activeName" @tab-click="onTabClick">
        ...
        <el-tab-pane name="2" :disabled="tabDisabled[1]">
          <span slot="label" class="paddmar"><i class="el-icon-circle-check zgschz"></i> 资格审查项汇总</span>
        </el-tab-pane>
...
<script>
  ...
  export default {
    ...
    let zgschz=this.$loaclStore.get(this.$commonFun.StoredValue(this)+"资格审查项汇总是否提交");
    let fhxscx=this.$loaclStore.get(this.$commonFun.StoredValue(this)+"符合性审查isSubmit");
    ...
    let pshz=this.$loaclStore.get(this.$commonFun.StoredValue(this)+'评审汇总是否提交');
      ...
      let zgsc1=this.$loaclStore.get(this.$commonFun.StoredValue(this)+'资格审查项1');
      let zgsc2=this.$loaclStore.get(this.$commonFun.StoredValue(this)+'资格审查项2');
