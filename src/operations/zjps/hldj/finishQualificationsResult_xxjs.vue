    ...
    <div class="leader_b">
      <el-tabs type="border-card" v-model="activeName" @tab-click="onTabClick">
        ...
        <el-tab-pane name="6" :disabled="tabDisabled[5]">
          <span slot="label" class="paddmar"><i class="el-icon-circle-check"></i> 详细评审（技术）汇总</span>
          <div>
            <el-row style="line-height:40px;">
              ...
              <el-col :span="12">
                <div class="grid-content bg-purple btnBox" style="text-align:right;">
                    ...
                    <el-button size="small" plain @click="individualTrial" v-if="!isSubmit">查看个人详细评审（技术）审查项表</el-button>
                    <el-button size="small" plain @click="checkUnlockRecord">查看详细评审（技术）审查项解锁记录</el-button>
                    <el-button size="small" plain @click="qualificationUnlockApplication">详细评审（技术）审查项解锁</el-button>
                </div>
              </el-col>
            </el-row>
            <el-table
