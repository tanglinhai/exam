...
<script>
  ...
  export default {
    ...
    created:function(){
      this.isSubmit = this.$loaclStore.get(this.$commonFun.StoredValue(this)+'zhpbbf_资格审查项汇总是否提交');
    },
    mounted(){
    ...
    methods: {
      ...
      goToNextStage(){
        ...
        this.$loaclStore.set(this.$commonFun.StoredValue(this)+'zhpbbf_资格审查项汇总是否提交', true);
      },
      changeView(url){
