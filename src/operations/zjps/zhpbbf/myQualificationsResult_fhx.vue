...
<script>
  ...
  export default {
    ...
    let pshz=this.$loaclStore.get(this.$commonFun.StoredValue(this)+'zhpbbf_评审汇总是否提交');
      ...
      let zgsc1=this.$loaclStore.get(this.$commonFun.StoredValue(this)+'zhpbbf_符合性审查项1');
      let zgsc2=this.$loaclStore.get(this.$commonFun.StoredValue(this)+'zhpbbf_符合性审查项2');
