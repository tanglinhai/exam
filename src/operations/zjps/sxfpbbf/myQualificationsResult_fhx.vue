    ...
    <div class="quexa_b">
      <el-tabs type="border-card" v-model="activeName">
        ...
        <el-tab-pane name="sec">
          <span slot="label"><i class="el-icon-circle-check"></i> 符合性审查项</span>
          <div>
            <el-row :gutter="20">
              <el-col :span="4">
        ...
        <el-tab-pane>
          <span slot="label" @click="changeView('/operation/zjps/hldj/unFinishQualificationsResult_fhx')"><i class="el-icon-circle-check"></i> 符合性审查项汇总</span>
        </el-tab-pane>
