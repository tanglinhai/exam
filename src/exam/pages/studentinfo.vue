              ...
              <el-row>
                <el-col :span="6">
                  <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="ruleForm">
                    ...
                    <el-form-item label="专家等级" prop="grade">
                      <el-select v-model="ruleForm.grade"  placeholder="请选等级">
                    ...
                    <el-form-item label="专业类别" prop="class">
    ...
    data(){
      return {
        ...
        rules: {
          ...
          grade: [
            {required: true, message: '请输入专家等级', trigger: 'blur'}
          ],
          class: [
